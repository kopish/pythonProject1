...
# в другой корутине будем дожидаться результата от данного футура.
# fut = event_loop.create_future()
fut = asyncio.Future()

# добавляем в цикл событий две задачи
event_loop.create_task(async_worker(3))
event_loop.create_task(async_worker(4))

# останавливаем цикл событий, независимо от успешности завершения в нём задач.
