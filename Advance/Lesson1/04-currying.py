...
# Выполнение обычной функции требует всех аргументов "прямо здесь и сейчас"
print(ordinary_add(2, 3))
print()
# Каррирование позволяет передавать аргументы в функцию постепенно: сначала первый аргумент, потом второй
